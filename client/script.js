...
sayHelloButton.addEventListener('mouseout', colorChanger)
...
const repeatMyParam = () => {
    ...
    axios.get(`${baseURL}repeat/someStr`)
    // axios.get('http://localhost:3000/repeat/someStr')
    .then(res => {

    console.log(res.data)
    const elem = document.getElementById('repeat-text')
...
const getRequest = () => {
    axios.get(`${baseURL}/query-test?myquery=query-is-mine&another-query=more-queries`)
    .then(res => {
        console.log(res.data)
    })
    .catch(err =>{
